...
class home extends Component{
    render(){
        ...
        <div id="wrapper">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-7">
                                            ...
                                            <form class="cart" method="post">
                                                <div class="quantity">
                                                    <span class="qty-minus" onc3lick="var effect = document.getElementById('qty'); var qty = effect.value; if( !isNaN( qty ) &amp;&amp; qty &gt; 1 ) effect.value--;return false;"><i class="fa fa-minus" aria-hidden="true"></i></span>
            ...
            {/* <!-- ****** Offer Area Start ****** --> */}
            <section class="offer_area height-700 section_padding_100 bg-img" style={{backgroundImage: 'url(img/bg-img/bg-5.jpg)'}}>
                <div class="container h-100">
